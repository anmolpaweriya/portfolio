export const projects = [
    {
        title: 'Wemeet - Real-time attendance tracking for meetings.',
    ...
    {
        title: 'CloudKeep - Store and access files for free',
        desc: 'CloudKeep is a free online file storage platform that lets users securely upload, store, and access files from anywhere. Built with Next.js for a fast and optimized user interface, TailwindCSS for responsive styling, and TypeScript for strong typing and improved code quality, it provides a seamless experience.',
        subdesc:
    ...
    {
        title: 'SwiftSend - Instant file sharing, no limits',
